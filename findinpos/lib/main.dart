...
class FindInPosApp extends StatefulWidget {
  @override
  FindInPosAppState createState() => new FindInPosAppState();
}

class FindInPosAppState extends State<FindInPosApp> {
